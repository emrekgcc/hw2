    ...
    public class OgrenciBilgileri {
        ...
        public OgrenciBilgileri() {
            this(null,null,"2018",2.5);
        }

        public OgrenciBilgileri(String ad, String bolum) {
            this(ad,bolum,"2020",3.2);
        }

        public OgrenciBilgileri(String ad, String bolum, String girisYili, double gano) {
            if (gano<0||gano>4){
        ...
        public OgrenciBilgileri(OgrenciBilgileri ogrenci){
